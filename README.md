...
db-world-sql/
├── 01-DDL.sql           # Table creation script
├── 02-Data_Insert.sql   # Data insertion script (country, city, countrylanguage)
├── 03-Soluciones.sql    # Solutions to every question in the assignment
├── Practica_1.pdf       # Original assignment statement
├── README.md            # This file
